...
export const entrance = Object.freeze({width:1.6,height:2.4,eyeHeight:1.62,openAngle:Math.PI*.54,openMs:1100,walkMs:4000});
...
export function sampleEntry(path, elapsed) {
  ...
  return {position,target:new Vector3(0,1.52,position.z-3.6),
    doorAngle:entrance.openAngle*smooth(elapsed/entrance.openMs),
